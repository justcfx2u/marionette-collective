module MCollective
  ...
  class Runner < Daemon
    ...
    def service_main
      ...
      Log.debug('service_main end')
    end

    def service_stop
      Log.warn("Exiting after service stop request")
      @connection.disconnect
      exit!
    end
